...
class _$CartModelImpl implements _CartModel {
  ...
  @override
  String toString() {
    return 'CartModel(id: $id, userId: $userId, companyName: $companyName, items: $items)';
  }
...
class _$CartItemModelImpl implements _CartItemModel {
  ...
  @override
  String toString() {
    return 'CartItemModel(productId: $productId, name: $name, price: $price, quantity: $quantity, stock: $stock)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, productId, name, price, quantity, stock);
